...
namespace Cassiopeia_Du_Couteau_2
{
    static class Program
    {
        ...
        public static void Loading_OnLoadingComplete()
        {
            ...
            QSet.Add(new MenuBool("UseQPok", "Use always [Q] if enemy is killable by Poison?", false));
            QSet.Add(new MenuBool("QComboDash", "Always use [Q] on Dash end position?", false));
            ComboMenu.Add(QSet);
            ...
            RSet.Add(new MenuBool("UseR", "Use [R]", false));
